...
const float wheeldiameter = 65.50; // Wheel diameter in millimeters, change if different
...
void ISR_countFL()  
{
  counter_FL++;  // increment Motor A counter value
} 

// Motor B pulse count ISR
void ISR_countFR()  
{
  counter_FR++;  // increment Motor B counter value
}

// Motor B pulse count ISR
void ISR_countBL()  
{
  counter_BL++;  // increment Motor B counter value
}

// Motor B pulse count ISR
void ISR_countBR()  
{
  counter_BR++;  // increment Motor B counter value
}
...
{
  counter_FL = 0;  //  reset counter A to zero
  counter_FR = 0;  //  reset counter B to zero
  counter_BL = 0;  //  reset counter A to zero
  counter_BR = 0;  //  reset counter B to zero
